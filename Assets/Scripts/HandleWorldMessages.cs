...
//			DoEmuRequestClose();
			...
			{
				byte[] SpawnAppearance = new byte[8];
				Int32 pos = 0;	
				WriteInt16 ((short)OurEntityID, ref SpawnAppearance, ref pos);
				WriteInt16 (14, ref SpawnAppearance, ref pos);
				WriteInt32 (115, ref SpawnAppearance, ref pos);
				GenerateAndSendWorldPacket (SpawnAppearance.Length, 465, curZoneId, curInstanceId, SpawnAppearance);
				
				byte[] Save = new byte[8];
				Int32 pos2 = 0;	
				WriteInt8 (0, ref Save, ref pos2);
				GenerateAndSendWorldPacket (Save.Length, 418, curZoneId, curInstanceId, Save);
			}
...
//joinkle			UIScriptsObject.SetActive(true);
